...
export const PanelIcon = (p: Props) => (
  <Stroke {...p} d="M4 4.8h6.2v5.6H4V4.8M13.8 4.8H20v3.4h-6.2V4.8M13.8 11.6H20v7.6h-6.2v-7.6M4 13.8h6.2v5.4H4v-5.4" />
);

export const LearnersIcon = (p: Props) => (
  <Stroke
    {...p}
    d="M9 5a3 3 0 100 6 3 3 0 000-6M3.5 19.5c1.1-2.9 3.1-4.4 5.5-4.4s4.4 1.5 5.5 4.4M16 5.4a3 3 0 010 5.6M17.5 15.4c1.4.7 2.5 2.1 3.2 4.1"
  />
);

export const ContentIcon = (p: Props) => (
  <Stroke {...p} d="M12 5.2 4 8.4l8 3.2 8-3.2-8-3.2M4 12.4l8 3.2 8-3.2M4 16.4l8 3.2 8-3.2" />
);

export const OrganizationIcon = (p: Props) => (
  <Stroke
    {...p}
    d="M4.5 20V6.2l7-2.2v16M11.5 9.5H19V20M3 20h18M7.5 9.6v.01M7.5 13.2v.01M7.5 16.8v.01M14.8 13.2v.01M14.8 16.8v.01"
  />
);
...
export const SettingsIcon = (p: Props) => (
  <Stroke
    {...p}
    d="M12 9.2a2.8 2.8 0 100 5.6 2.8 2.8 0 000-5.6M19.2 14.4a1.6 1.6 0 00.3 1.7l.1.1a1.9 1.9 0 11-2.7 2.7l-.1-.1a1.6 1.6 0 00-2.7 1.1v.2a1.9 1.9 0 11-3.8 0v-.1a1.6 1.6 0 00-2.8-1.1l-.1.1A1.9 1.9 0 114 16.4l.1-.1a1.6 1.6 0 00-1.1-2.7H2.8a1.9 1.9 0 110-3.8h.1A1.6 1.6 0 004 7.1L3.9 7A1.9 1.9 0 116.6 4.3l.1.1a1.6 1.6 0 001.7.3H8.5a1.6 1.6 0 001-1.5v-.2a1.9 1.9 0 113.8 0v.1a1.6 1.6 0 002.7 1.1l.1-.1A1.9 1.9 0 1120 7l-.1.1a1.6 1.6 0 00-.3 1.7v.1a1.6 1.6 0 001.5 1h.2a1.9 1.9 0 110 3.8h-.1a1.6 1.6 0 00-1.5 1z"
  />
);
