...
export const ES = {
  ...
  signupCodeBad: "No encontramos ese código.",
  signupJoining: (org: string) => "Te unes a " + org,
  signupDemoJoining: (org: string) => "Vas a probar la app en " + org,
  signupName: "Tu nombre",
  signupEmail: "Tu correo",
  signupPin: "Tu PIN de 4 números",
  signupPinConfirm: "Repite tu PIN",
  signupPinHint: "Con este PIN vas a entrar. Solo 4 números.",
  signupCta: "Crear mi cuenta",
  signupHaveAccount: "¿Ya tienes cuenta? Entra aquí",
  signupLegal: "Al registrarte aceptas los términos y el aviso de privacidad.",
  signupBadFields: "Escribe tu nombre y un correo válido.",
  signupTaken: "Ya existe una cuenta con ese correo. Entra con tu PIN.",
  signupNoDemo:
    "El registro abierto no está disponible ahora mismo. Pide el código de tu organización.",
  joinBadCode: "Ese enlace no corresponde a ninguna organización.",
  joinTryDemo: "Registrarme para probar la app",
  pwNotPin: "Tu PIN son 4 números.",
  resetHint: "Si eres aprendiz, tu clave son 4 números.",
  ...
  payStatusDisabled: "Tu pago no fue validado. Habla con tu administrador.",
...
export const EN: Translated = {
  ...
  signupCodeHint:
    "Four digits. If you don't have one, leave it empty and try the app.",
  signupCodeBad: "We couldn't find that code.",
  signupJoining: (org) => "You're joining " + org,
  signupDemoJoining: (org) => "You'll try the app in " + org,
  signupName: "Your name",
  signupEmail: "Your email",
  signupPin: "Your 4-digit PIN",
  signupPinConfirm: "Repeat your PIN",
  signupPinHint: "You'll sign in with this PIN. Four digits only.",
  signupCta: "Create my account",
  signupHaveAccount: "Already have an account? Sign in",
  signupLegal: "By registering you accept the terms and the privacy notice.",
  signupBadFields: "Enter your name and a valid email.",
  signupTaken: "An account with that email already exists. Sign in with your PIN.",
  signupNoDemo:
    "Open registration isn't available right now. Ask for your organisation's code.",
  joinBadCode: "That link doesn't match any organisation.",
  joinTryDemo: "Register to try the app",
  pwNotPin: "Your PIN is 4 digits.",
  resetHint: "If you're a learner, your key is 4 digits.",
  ...
  payStatusDisabled: "Your payment was not validated. Talk to your administrator.",
